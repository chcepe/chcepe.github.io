...
export default ((): Project => ({
  ...
  name: "Crave - Catering",
  desc: "Similar to <a href='https://play.google.com/store/apps/details?id=com.crave.consumerapp&hl=en&gl=US' target='_blank'><strong>Crave Delivery app</strong></a>, however it is designed specifically for businesses and events for bigger orders.",
