...
export default ((): Project => ({
  ...
  thumbnail: "project-assets/minerva/thumb.jpg",
  logo: "project-assets/minerva/logo.png",
  ...
  preview: [
    {
      img: "project-assets/minerva/thumb.jpg",
      caption: "Cover photo for Play Store",
    },
    {
      img: "project-assets/minerva/brochure.jpg",
      caption: "Brochure",
    },
    {
      yt: "5CgcdIsPvNs",
  ...
  platforms: [
    {
      type: "web",
      link: "https://web.archive.org/web/20171025034145/http://minerva-eye.com/",
    },
    {
      type: "android",
      link: "https://play.google.com/store/apps/details?id=com.chcepe.minerva&hl=en",
    },
  ],
}))();
